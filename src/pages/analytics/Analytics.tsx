...
function Analytics() {
  ...
  const { data: keyCachedData }: any = queryClient.getQueryData([
    'employeesData',
  ]);
  return (
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 p-4">
        ...
        >
          <PieChartComponent
            ...
            chartType={'pie'}
            data={cachedData?.departmentHeadcount}
          />
          <LineChartComponent
            name={'Revenue'}
            X={'month'}
          ...
          <LineChartComponent
            ...
            Y={'rate'}
            chartType={'line'}
            data={cachedData?.attritionInsights?.trend}
          ...
          <BarChartComponent
            ...
            chartType={'bar'}
            data={cachedData?.skillsInDemand}
          />
          <PieChartComponent
            X={'client'}
