...
function Home(){
  // Queries
    ...
    const { isLoading: performanceDataLoading , error: performanceCardError } = usePerformanceCardData();
    const { isLoading: analyticsDataLoading, error: analyticsDataError } = useAnalyticsData();
    ...
    if(userError || performanceCardError || analyticsDataError) return <>Error occurred...</>
