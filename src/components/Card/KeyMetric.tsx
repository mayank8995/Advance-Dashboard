  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4">
      {!isLoading ? (
        ...
        <div className=" animate-pulse grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 p-4">
          {[1, 2, 3, 4]?.map((_, i) => (
            <div
              key={`items-start-${i}`}
            ...
            >
              <div className="items-center flex flex-row ">
                <div
                  className={`h-10 w-10 rounded-xl bg-gray-200 dark:bg-gray-700 flex items-center justify-center`}
                ></div>
                <div className="pl-2 flex flex-col">
                  <div className="h-2  bg-gray-200 dark:bg-gray-700 hidden sm:flex items-center mb-1 text-sm text-slate-500 font-medium dark:text-slate-100 w-50 truncate"></div>
                  <h2 className="h-2 bg-gray-200 dark:bg-gray-700 text-xl font-bold text-gray-200 drop-shadow-sm "></h2>
                </div>
              </div>
            </div>
          ))}
